              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <div class="flex items-center gap-3 px-3 py-2 rounded-lg bg-[#f0f1f4]">
                    <div class="text-[#121317]" data-icon="Check" data-size="24px" data-weight="fill">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                        <path
          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div class="flex flex-wrap gap-4 p-4">
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-lg p-6 bg-[#f0f1f4]">
                <p class="text-[#121317] text-base font-medium leading-normal">Pendaftar Baru Hari Ini</p>
                <p class="text-[#121317] tracking-light text-2xl font-bold leading-tight">15</p>
              </div>
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-lg p-6 bg-[#f0f1f4]">
                <p class="text-[#121317] text-base font-medium leading-normal">Total Menunggu Verifikasi</p>
                <p class="text-[#121317] tracking-light text-2xl font-bold leading-tight">32</p>
              </div>
            </div>
            <div class="px-4 py-3 @container">
              <div class="flex overflow-hidden rounded-lg border border-[#dcdee5] bg-white">
                <table class="flex-1">
                  <thead>
                    <tr class="bg-white">
                      <th class="table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-120 px-4 py-3 text-left text-[#121317] w-[400px] text-sm font-medium leading-normal">
                        Nama Mahasiswa
                      </th>
                      <th class="table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-240 px-4 py-3 text-left text-[#121317] w-[400px] text-sm font-medium leading-normal">
                        Nama Beasiswa
                      </th>
                      <th class="table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-360 px-4 py-3 text-left text-[#121317] w-60 text-sm font-medium leading-normal">
                        Status Dokumen
                      </th>
                      <th class="table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-480 px-4 py-3 text-left text-[#121317] w-60 text-[#656d86] text-sm font-medium leading-normal">
                        Aksi
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr class="border-t border-t-[#dcdee5]">
                      <td class="table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-120 h-[72px] px-4 py-2 w-[400px] text-[#121317] text-sm font-normal leading-normal">
                        Budi Santoso
                      </td>
                      <td class="table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-240 h-[72px] px-4 py-2 w-[400px] text-[#656d86] text-sm font-normal leading-normal">
                        Beasiswa Prestasi Akademik
                      </td>
                      <td class="table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-360 h-[72px] px-4 py-2 w-60 text-sm font-normal leading-normal">
                        <button
                      ...
                      <td class="table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-480 h-[72px] px-4 py-2 w-60 text-[#656d86] text-sm font-bold leading-normal tracking-[0.015em]">
                        Verifikasi
                      </td>
                    </tr>
                    <tr class="border-t border-t-[#dcdee5]">
              ...
              <style>
                          @container(max-width:120px){.table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-120{display: none;}}
                @container(max-width:240px){.table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-240{display: none;}}
                @container(max-width:360px){.table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-360{display: none;}}
                @container(max-width:480px){.table-68af9c87-86e6-4064-9012-4f6a7a8294ca-column-480{display: none;}}
              </style>
            </div>
          </div>
        </div>
