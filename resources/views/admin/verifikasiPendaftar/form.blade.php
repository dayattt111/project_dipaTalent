          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
              ...
              <div class="flex items-stretch justify-between gap-4 rounded-lg">
                <div class="flex flex-[2_2_0px] flex-col gap-4">
                  <div class="flex flex-col gap-1">
                    <p class="text-[#121317] text-base font-bold leading-tight">Budi Santoso</p>
                    <p class="text-[#656d86] text-sm font-normal leading-normal">NIM: 202210201001</p>
                  </div>
                  <button
                  ...
                  >
                    <span class="truncate">Beasiswa Prestasi Akademik</span>
                  </button>
                </div>
                <div
                  class="w-full bg-center bg-no-repeat aspect-video bg-cover rounded-lg flex-1"
                  style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCwk1pXOUOXEOFE5_xkLdc9BIURdJq6DoD_60ZnsrbVMcfmScd01mm5s0olyCSuUaW8hlqCAGYXkNzVlr3Qw2hdLm-mV0GtmwJLHhVFqcTJNg9phjRbk3tApO2umubj3WN8KXR0mFdkUk8P6XkrWvHYecSsd1-QOxQYhzoGCNQVdvnJKvN2OXKiFgwAJWWGO63aY_OVaT8L0xAVN3Zxm6gsn91eTpmvjUyO1zfQp3Eegu1OTF28fp4jfLPQRhL4tC4J5fFtxjUzrQ");'
                ></div>
              </div>
            </div>
            <div class="p-4 grid grid-cols-2">
              <div class="flex flex-col gap-1 border-t border-solid border-t-[#dcdee5] py-4 pr-2">
                ...
                <p class="text-[#121317] text-sm font-normal leading-normal">3.85</p>
              </div>
              <div class="flex flex-col gap-1 border-t border-solid border-t-[#dcdee5] py-4 pl-2">
                ...
                <p class="text-[#121317] text-sm font-normal leading-normal">Juara 1 Lomba Karya Ilmiah Nasional (2023), Finalis Debat Bahasa Inggris Tingkat Universitas (2022)</p>
              </div>
              <div class="flex flex-col gap-1 border-t border-solid border-t-[#dcdee5] py-4 pr-2">
                <p class="text-[#656d86] text-sm font-normal leading-normal">Pengalaman Organisasi</p>
                <p class="text-[#121317] text-sm font-normal leading-normal">Ketua Himpunan Mahasiswa Teknik Informatika (2023-2024)</p>
              </div>
              <div class="flex flex-col gap-1 border-t border-solid border-t-[#dcdee5] py-4 pl-2">
                <p class="text-[#656d86] text-sm font-normal leading-normal">Keterampilan Khusus</p>
                <p class="text-[#121317] text-sm font-normal leading-normal">Pemrograman Python, Analisis Data, Desain UI/UX</p>
              </div>
              <div class="flex flex-col gap-1 border-t border-solid border-t-[#dcdee5] py-4 pr-2">
                <p class="text-[#656d86] text-sm font-normal leading-normal">Transkrip Nilai</p>
                <p class="text-[#121317] text-sm font-normal leading-normal">Unduh</p>
              </div>
              <div class="flex flex-col gap-1 border-t border-solid border-t-[#dcdee5] py-4 pl-2">
                <p class="text-[#656d86] text-sm font-normal leading-normal">Catatan Admin</p>
                <p class="text-[#121317] text-sm font-normal leading-normal">Tambahkan catatan...</p>
              </div>
            </div>
