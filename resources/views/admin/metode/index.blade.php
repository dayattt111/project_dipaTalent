      ...
      <div class="layout-container flex h-full grow flex-col">
        <div class="gap-1 px-6 flex flex-1 justify-center py-5">
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <div class="flex items-center gap-3 px-3 py-2 rounded-lg bg-[#f0f1f4]">
                    <div class="text-[#121317]" data-icon="SlidersHorizontal" data-size="24px" data-weight="fill">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                        <path
          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4"><p class="text-[#121317] tracking-light text-[32px] font-bold leading-tight min-w-72">Atur Bobot SAW</p></div>
            <p class="text-[#121317] text-base font-normal leading-normal pb-3 pt-1 px-4">
              Sesuaikan bobot untuk setiap kriteria penilaian beasiswa. Pastikan total bobot adalah 100%.
            </p>
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#121317] text-base font-medium leading-normal pb-2">IPK</p>
                <input
            ...
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#121317] text-base font-medium leading-normal pb-2">Prestasi Akademik</p>
                <input
                  class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#121317] focus:outline-0 focus:ring-0 border border-[#dcdee5] bg-white focus:border-[#dcdee5] h-14 placeholder:text-[#656d86] p-[15px] text-base font-normal leading-normal"
                  value=""
                />
            ...
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#121317] text-base font-medium leading-normal pb-2">Prestasi Non-Akademik</p>
                <input
                  class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#121317] focus:outline-0 focus:ring-0 border border-[#dcdee5] bg-white focus:border-[#dcdee5] h-14 placeholder:text-[#656d86] p-[15px] text-base font-normal leading-normal"
                  value=""
                />
            ...
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#121317] text-base font-medium leading-normal pb-2">Pengalaman Organisasi</p>
                <input
                  class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#121317] focus:outline-0 focus:ring-0 border border-[#dcdee5] bg-white focus:border-[#dcdee5] h-14 placeholder:text-[#656d86] p-[15px] text-base font-normal leading-normal"
                  value=""
                />
            ...
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#121317] text-base font-medium leading-normal pb-2">Keterampilan Khusus</p>
                <input
                  class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#121317] focus:outline-0 focus:ring-0 border border-[#dcdee5] bg-white focus:border-[#dcdee5] h-14 placeholder:text-[#656d86] p-[15px] text-base font-normal leading-normal"
                  value=""
                />
            ...
            <p class="text-[#656d86] text-sm font-normal leading-normal pb-3 pt-1 px-4">Total Bobot: 100% (Valid)</p>
            <div class="flex px-4 py-3 justify-start">
              ...
              >
                <span class="truncate">Terapkan Bobot</span>
              </button>
            </div>
          </div>
        </div>
